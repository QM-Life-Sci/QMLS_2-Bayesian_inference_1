...
- You will want the latest version of RTools, because that will match the latest "point" version of R.
...
CI_dat |>
  ...
  geom_segment(aes(y = index, yend = index,
                   x = lower, xend = upper)) +
